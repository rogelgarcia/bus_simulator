...
function materialRecord(material, bindingByTexture) {
    ...
    const hasOwnShaderPatch = shaderContract.hasOwnShaderPatch || shaderContract.hookIds.some((id) =>
        !['city.cascaded_shadows', 'city.finite_sun', 'lighting.calibrated_diffuse_ibl', 'illumination.static_sun_depth', 'illumination.receiver_lightmaps', 'ao.dynamic_contact'].includes(id));
