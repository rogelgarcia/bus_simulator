// src/graphics/gui/building_fabrication/mini_controllers/MaterialPickerRowController.js
// Material picker row controller with optional status + disposal.
import { applyTooltip, appendMustHaveDot } from './UiMiniControlPrimitives.js';
