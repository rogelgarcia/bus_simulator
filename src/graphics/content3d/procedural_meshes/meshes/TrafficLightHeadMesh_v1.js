// src/graphics/content3d/procedural_meshes/meshes/TrafficLightHeadMesh_v1.js
...
export function createAsset() {
    ...
    const semanticMaterials = makeRegionMaterials(regions, { wireframe: false, metalness: 0.0, roughness: 0.6 });
    ...
    const rig = createTrafficLightHeadRig({
        regions,
        materials: { semantic: semanticMaterials, solid: solidMaterials }
    });
    mesh.userData.rig = rig;
    mesh.userData.api = createTrafficLightHeadLegacySkeletonApi(rig);
