// src/states/BuildingFabricationState.js
// Wires the building fabrication view into the state machine.
import { BuildingFabricationView } from '../graphics/gui/building_fabrication/BuildingFabricationView.js';

export class BuildingFabricationState {
    ...
    enter() {
        ...
        this.view = new BuildingFabricationView(this.engine);
        this.view.enter();
