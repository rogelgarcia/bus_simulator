// src/states/rapier_debugger/RapierDebuggerState.js
import { RapierDebuggerView } from '../../graphics/gui/rapier_debugger/RapierDebuggerView.js';

export class RapierDebuggerState {
    ...
    enter() {
        ...
        this.view = new RapierDebuggerView(this.engine);
        this.view.enter();
