// src/states/MeshInspectorState.js
// Wires the mesh inspector view into the state machine.
import { MeshInspectorView } from '../graphics/gui/mesh_inspector/MeshInspectorView.js';
...
export class MeshInspectorState {
    ...
    enter() {
        ...
        this.view = new MeshInspectorView(this.engine);
        this.view.enter();
