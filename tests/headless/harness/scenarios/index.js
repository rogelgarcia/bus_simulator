...
import { scenarioDaylightCalibration } from './scenario_daylight_calibration.js';
...
import {
    scenarioAi516Burban,
    scenarioAi516BurbanCloseup,
    scenarioAi516BurbanCloseupNeutral,
    scenarioAi516BurbanNeutral
} from './scenario_ai516_burban.js';

const REGISTRY = new Map([
    [scenarioPhysicalLightingCalibration.id, scenarioPhysicalLightingCalibration],
    [scenarioDaylightCalibration.id, scenarioDaylightCalibration],
    ...
    [scenarioAi516BurbanCloseupNeutral.id, scenarioAi516BurbanCloseupNeutral]
]);
