...
| 6 | `AI_DONE_532_VEHICLES_static_world_to_bus_and_dynamic_bus_shadows_DONE.md` | AI 527–531 | **Complete.** Generic registered moving receivers sample static-world shadows; one shared dynamic field provides self/world/two-mover interaction and supersedes overlapping AI 498 bus-map work. |
| 7 | `AI_DONE_533_MATERIAL_baked_direct_and_indirect_illumination_DONE.md` | AI 527–532 | Accepted optional direct/indirect channels and AI 548; deterministic receiver mapping, linear PBR integration and measured limits. |
| 8 | `AI_DONE_534_MATERIAL_baked_gi_and_ambient_occlusion_migration_DONE.md` | AI 527–533 | Completed All / Dynamic Only composition, full bus contact, measured AO costs and AI 323/524/525 disposition. |
