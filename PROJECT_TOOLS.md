...
| staticSunDepth | `tools/static_sun_depth/` | Compile guarded RG8 fixtures and run strict production/Lab Scene current-versus-cache validation without promoting lab fixtures | `node tools/static_sun_depth/run.mjs --help`; `node tools/static_sun_depth/validate_lab.mjs --help` |
