...
| staticSunDepth | `tools/static_sun_depth/` | Validate and quantize AI 529 static-depth intermediates into deterministic guarded RG8 fixture artifacts without making production claims | `node tools/static_sun_depth/run.mjs --help` |
